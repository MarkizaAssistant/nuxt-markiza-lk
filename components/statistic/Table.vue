<template>
  <div class="relative">
    ...
    <div v-else-if="chatStore.hasChats" class="h-[600px] overflow-y-auto table-container pr-2">
      <div v-if="chatsData">
